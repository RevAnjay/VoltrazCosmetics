package com.francobm.magicosmetics.nms.v1_21_R7.cache;

import com.francobm.magicosmetics.nms.v1_21_R7.ReflectionUtils;
...
public class EntityBalloonHandler extends EntityBalloon {
    ...
    public void updateBigHead(){
        ...
        if(distSq > SQUARED_WALKING){
            ...
            tempStandTo.setDirection(tempStandDir);
            tempStandTo.add(tempDistVec);
            ReflectionUtils.absMoveTo(leashed, tempStandTo.getX(), tempStandTo.getY(), tempStandTo.getZ(), tempStandTo.getYaw(), tempStandTo.getPitch());
            ReflectionUtils.absMoveTo(armorStand, tempStandTo.getX(), tempStandTo.getY() - 1.3, tempStandTo.getZ(), tempStandTo.getYaw(), tempStandTo.getPitch());
        }else {
            if (tempStandDir.lengthSquared() > 0) {
                tempStandDir.normalize();
            }
