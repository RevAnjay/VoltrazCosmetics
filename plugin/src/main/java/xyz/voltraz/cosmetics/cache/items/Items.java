package xyz.voltraz.cosmetics.cache.items;
...
import xyz.voltraz.cosmetics.cache.SecondaryColor;
...
import xyz.voltraz.cosmetics.cache.Color;
...
public class Items {
    ...
    public static void loadItems(){
        ...
        items.clear();
        FileCreator menu = VoltrazCosmetics.getInstance().getMenus();
        int items_count = 0;
    ...
    public Items addVariable(String variable, CosmeticType cosmeticType){
        ...
        ItemMeta itemMeta = itemStack.getItemMeta();
        List<String> lore = new ArrayList<>();
        FileCreator messages = VoltrazCosmetics.getInstance().getMessages();
        if(itemMeta == null) return this;
        switch (cosmeticType){
            case HAT:
                if(itemMeta.hasDisplayName()) {
