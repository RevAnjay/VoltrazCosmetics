...
public class BalloonIA {
    ...
    private void addPlayer(PufferFish pufferFish, Entity owner, Player player) {
        ...
        VoltrazCosmetics.getInstance().getVersion().showEntity(pufferFish, player);
        VoltrazCosmetics.getInstance().getVersion().attachFakeEntity(owner, pufferFish, player);
    }
    ...
    public void removePlayer(PufferFish pufferFish, Player player) {
        ...
        VoltrazCosmetics.getInstance().getVersion().despawnFakeEntity(pufferFish, player);
    }
    ...
    public PufferFish spawnLeash(Location location) {
        return VoltrazCosmetics.getInstance().getVersion().spawnFakePuffer(location);
    }
    ...
    public void updateTeleport(PufferFish leashed) {
        ...
        VoltrazCosmetics.getInstance().getVersion().updatePositionFakeEntity(leashed, leashBone.getLocation().add(0, 1.6, 0));
