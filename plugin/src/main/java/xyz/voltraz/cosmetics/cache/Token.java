...
import xyz.voltraz.cosmetics.api.TokenType;
...
public class Token {
    ...
    public boolean isNewToken(ItemStack itemStack){
        ...
        /*if(VoltrazCosmetics.getInstance().isItemsAdder()) {
            if (VoltrazCosmetics.getInstance().getItemsAdder().getCustomStack(itemStack) != null) {
        ...
        String key = VoltrazCosmetics.getInstance().getVersion().isNBTCosmetic(itemStack);
