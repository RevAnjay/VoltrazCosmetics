...
import xyz.voltraz.cosmetics.cache.Panel;
...
public abstract class Menu implements InventoryHolder {
    ...
    public void open(){
        ...
        if(VoltrazCosmetics.getInstance().isPlaceholderAPI()){
            getContentMenu().createInventory(this, VoltrazCosmetics.getInstance().getPlaceholderAPI().setPlaceholders(playerData.getOfflinePlayer().getPlayer(), getContentMenu().getTitle()));
        }else {
    ...
    public static void loadMenus(){
        ...
        VoltrazCosmetics.getInstance().getLogger().info("Registered menus: " + menus_count);
    }
    ...
    public void setItemInMenu(SlotMenu slotMenu){
        ...
        if(slotMenu.getItems() == null){
            VoltrazCosmetics.getInstance().getLogger().info("Slot: " + slotMenu.getSlot() + " is Null!");
            return;
        }
