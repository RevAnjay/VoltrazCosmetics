...
import xyz.voltraz.cosmetics.utils.Cuboid;
...
public class Zone {
    ...
    public static void loadZones(){
        zones.clear();
        FileCreator zone = VoltrazCosmetics.getInstance().getZones();
        ...
        for(String key : zone.getConfigurationSection("zones").getKeys(false)){
            ...
            if(zone.contains("zones." + key + ".corn1")){
                ...
                if(c1.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of Corn1 is Null... skipping zone " + key);
                    continue;
                }else{
            ...
            if(zone.contains("zones." + key + ".corn2")){
                ...
                if(c2.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of Corn2 is Null... skipping zone " + key);
                    continue;
                }else{
            ...
            if(zone.contains("zones." + key + ".npc")){
                ...
                if(npcString.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of NPC is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".enter")){
                ...
                if(enterString.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of Enter is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".exit")){
                ...
                if(exitString.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of Exit is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".balloon")){
                ...
                if(balloonString.equalsIgnoreCase("Location is Null!!")){
                   VoltrazCosmetics.getInstance().getLogger().info("Location of Balloon is Null!");
                }else{
            ...
            if(zone.contains("zones." + key + ".spray")){
                ...
                if(sprayLocString.equalsIgnoreCase("Location is Null!!")){
                    VoltrazCosmetics.getInstance().getLogger().info("Location of Spray is Null!");
                }else{
                    sprayLoc = Utils.convertStringToLocation(sprayLocString);
                    try{
                        sprayFace = BlockFace.valueOf(sprayFaceString.toUpperCase());
                    }catch(IllegalArgumentException e){
                        VoltrazCosmetics.getInstance().getLogger().info("Face of Spray is Null!");
                    }
                }
            }
    ...
    public static void removeZone(String id){
        ...
        FileCreator zoneConf = VoltrazCosmetics.getInstance().getZones();
    ...
    public ItemStack getCorn(){
        ...
        return VoltrazCosmetics.getInstance().getVersion().setNBTCosmetic(itemStack, "wand" + getName());
    }
