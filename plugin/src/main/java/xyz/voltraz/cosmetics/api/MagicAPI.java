...
public class MagicAPI {
    ...
    public static boolean tintItem(ItemStack item, String colorHex){
        return VoltrazCosmetics.getInstance().getCosmeticsManager().tintItem(item, colorHex);
    }
    ...
    public static String getCosmeticId(String name, String type){
        ...
        try{
            ...
            VoltrazCosmetics.getInstance().getLogger().warning("Invalid cosmetic type: " + type);
        }
        return null;
    }
